<div class="modal fade" id="jadwalPsikotesModal" tabindex="-1" role="dialog" aria-labelledby="jobLabel" aria-hidden="true">
                    ...
                    <div class="row py-2">
                        <div class="col-md-12">
                            ...
                            <div class="form-group fill form-show-validation">
                                ...
                                <input type="datetime-local" id="time_psikotes" name="time_psikotes" class="form-control"
