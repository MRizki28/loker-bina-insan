...
@section('content')
    ...
    <x-penilaian.penilaianpsikotes-modal></x-penilaian.penilaianpsikotes-modal>
    <x-psikotes.psikotes-modal></x-psikotes.psikotes-modal>
@endsection

@section('js-service')
    <script type="module" src="{{ asset('js/psikotes.controller.js') }}?v={{ time() }}"></script>
@endsection
