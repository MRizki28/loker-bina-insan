...
@section('content')
                                    ...
                                    <div class="account-settings">
                                        <div class="user-profile">
                                            <div class="user-avatar">
                                                <img src="{{ asset('static/img/logo.png') }}" class="w-100 h-100"
                                                    alt="User">
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formSetting').submit(async function(e) {
                e.preventDefault();
                ...
                try {
                    ...
                    submitButton.attr('disabled', true);
                    const response = await axios.post(`/v1/auth/setting`, formData);
                    ...
                    }else if(responseData.message == 'Old password is wrong') {
                        Swal.fire({
                            icon: "error",
                            title: "Gagal",
